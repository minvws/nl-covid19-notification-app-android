...
class EndOfLifeFragment : BaseFragment(R.layout.fragment_end_of_life) {
    ...
    private val endOfLifeViewModel: EndOfLifeViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        endOfLifeViewModel.endOfLifeContent.observe(viewLifecycleOwner) {
            val (title, body) = it ?: return@observe
